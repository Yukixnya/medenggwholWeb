...
// import { CustomInput, CustomDropdown } from '../components/CustomInput'
//
...
//     setFieldErrs(e); return Object.keys(e).length === 0
//   }
//   function fmtDate(d) {
//     if (!d) return ''
//     const dt = new Date(d)
...
//     const updated = { ...userData, name:name.trim(), email:email.trim(), mobile:mobile.trim(),
//       age:age.trim(), gender, appointmentDate:selDate, appointmentTime:selTime }
//     setUserData(updated); saveUserProfile(updated)
//     await new Promise(r => setTimeout(r, 400))
//     notifyDoctor(); await new Promise(r => setTimeout(r, 900))
//     confirmPatient(); await new Promise(r => setTimeout(r, 900))
//     notifyAdmin()
...
//         minHeight:'100vh', background:'#F5F7FF', padding:32, textAlign:'center',
//         fontFamily:"'Plus Jakarta Sans','Segoe UI',sans-serif" }}>
//         <style>{`@keyframes scaleIn { from{opacity:0;transform:scale(0.7)} to{opacity:1;transform:scale(1)} }`}</style>
//         <div style={{ animation:'scaleIn 0.4s ease', display:'flex', flexDirection:'column', alignItems:'center', gap:20 }}>
//           <div style={{ width:90, height:90, borderRadius:'50%',
//             background:'linear-gradient(135deg,#E8F5E9,#C8E6C9)',
//             border:'2px solid #A5D6A7',
//             display:'flex', alignItems:'center', justifyContent:'center' }}>
//             <span className="material-icons" style={{ fontSize:46, color:'#2E7D32' }}>check_circle</span>
//           </div>
//           <div>
//             <h2 style={{ fontSize:22, fontWeight:800, color:'#0A1628', margin:'0 0 8px' }}>
//               Appointment Booked! 🎉
//             </h2>
//             <p style={{ color:'#6B7280', fontSize:14, margin:'0 0 4px' }}>
//               {selectedDoctor?.name||'Our doctor'} will contact you soon.
//             </p>
//             <p style={{ color:'#9CA3AF', fontSize:12, margin:0 }}>Redirecting to home in 3s...</p>
//           </div>
//           <div style={{ background:'#fff', borderRadius:16, padding:'16px 20px', width:'100%', maxWidth:300,
...
//               {selectedDoctor?.name||'Specialist'}
//             </span>
//             </div>
//             <div style={{ display:'flex', justifyContent:'space-between', marginBottom:8 }}>
//               <span style={{ fontSize:12, color:'#9CA3AF' }}>Date</span>
//               <span style={{ fontSize:12, fontWeight:700, color:'#0A1628' }}>{fmtDate(selDate)}</span>
//             </div>
//             <div style={{ display:'flex', justifyContent:'space-between' }}>
//               <span style={{ fontSize:12, color:'#9CA3AF' }}>Time</span>
//               <span style={{ fontSize:12, fontWeight:700, color:'#0A1628' }}>{selTime}</span>
//             </div>
//           </div>
//         </div>
//       </div>
...
//                     display:'flex', alignItems:'center', justifyContent:'center' }}>
//                     <span className="material-icons" style={{ color:'#fff', fontSize:26 }}>person</span>
//                   </div>
//                   <div style={{ flex:1 }}>
//                     <p style={{ color:'rgba(255,255,255,0.55)', fontSize:11, margin:'0 0 2px', letterSpacing:0.3 }}>
//                       YOUR ASSIGNED DOCTOR
//                     </p>
//                     <p style={{ color:'#fff', fontWeight:800, fontSize:15, margin:'0 0 1px' }}>
//                       {selectedDoctor.name}
//                     </p>
...
//                     </p>
//                   </div>
//                   <span className="material-icons" style={{ color:'#4FC3F7', fontSize:22 }}>verified</span>
//                 </div>
//             )}
//
//             {/* Pre-fill notice */}
...
//               <span className="material-icons" style={{ fontSize:16, color:'#16A34A' }}>check_circle_outline</span>
//               <p style={{ fontSize:12, color:'#15803D', margin:0, fontWeight:600 }}>
//                 Your info has been pre-filled from your profile
//               </p>
//             </div>
//
//             {/* Personal Info */}
//             <SectionCard icon="person_outline" title="Personal Information">
//               <Field err={fieldErrs.name}>
//                 <CustomInput label="Full Name" hint="Enter your full name" value={name} onChange={setName} prefixIcon="person" />
//               </Field>
//               <Field err={fieldErrs.email}>
//                 <CustomInput label="Email Address" hint="your@email.com" type="email" value={email} onChange={setEmail} prefixIcon="email" />
//               </Field>
//               <Field err={fieldErrs.mobile}>
//                 <CustomInput label="Mobile Number" hint="10-digit number" type="tel"
//                              value={mobile} onChange={v => setMobile(v.replace(/\D/g,'').slice(0,10))} prefixIcon="phone_android" />
//               </Field>
//               <div style={{ display:'flex', gap:12 }}>
//                 <div style={{ flex:1 }}>
//                   <Field err={fieldErrs.age}>
//                     <CustomInput label="Age" hint="Your age" type="tel"
//                                  value={age} onChange={v => setAge(v.replace(/\D/g,'').slice(0,3))} prefixIcon="cake" />
//                   </Field>
//                 </div>
//                 <div style={{ flex:1 }}>
//                   <CustomDropdown label="Gender" value={gender} onChange={setGender} options={GENDERS} />
//                 </div>
//               </div>
//             </SectionCard>
//
//             {/* Appointment Details */}
//             <SectionCard icon="calendar_today" title="Appointment Details">
//               {/* Date */}
//               <div>
...
//                   background:'#F8FAFF', border:`1.5px solid ${selDate?'#2979FF':'#E5E9F5'}`,
//                   borderRadius:12, padding:'13px 14px', cursor:'pointer' }}>
//                   <span className="material-icons" style={{ fontSize:18, color:'#2979FF' }}>calendar_today</span>
//                   <span style={{ flex:1, fontSize:14,
//                     color: selDate?'#0A1628':'#9CA3AF', fontWeight: selDate?600:400 }}>
//                   {selDate ? fmtDate(selDate) : 'Select Appointment Date'}
//                 </span>
//                   <input type="date" min={todayStr} max={maxStr} value={selDate}
//                          onChange={e => setSelDate(e.target.value)}
//                          style={{ position:'absolute', opacity:0, width:0, height:0 }} />
//                   <span className="material-icons" style={{ fontSize:18, color:'#9CA3AF' }}>expand_more</span>
//                 </label>
//               </div>
//
//               {/* Time slots */}
...
//                           border: `1.5px solid ${active?'#2979FF':'#E5E9F5'}`,
//                           boxShadow: active?'0 3px 12px rgba(41,121,255,0.3)':'none',
//                         }}>{slot}</button>
//                     )
//                   })}
//                 </div>
...
//                     background:'#FEF2F2', padding:'10px 12px', borderRadius:10 }}>
//                     <span className="material-icons" style={{ fontSize:15, color:'#DC2626' }}>error_outline</span>
...
//         <div style={{ background:'#fff', padding:'14px 20px 24px',
//           boxShadow:'0 -4px 20px rgba(10,22,40,0.08)',
//           position:'sticky', bottom:0, display:'flex', flexDirection:'column', gap:10 }}>
//           <button onClick={submitAppointment} disabled={isSubmitting} style={{
//             padding:'15px', borderRadius:14, border:'none', cursor:'pointer',
//             background: isSubmitting?'#93C5FD':'linear-gradient(135deg,#2979FF,#0097A7)',
//             color:'#fff', fontSize:15, fontWeight:700,
//             display:'flex', alignItems:'center', justifyContent:'center', gap:8,
//             boxShadow:'0 4px 18px rgba(41,121,255,0.35)',
//           }}>
//             {isSubmitting
//                 ? <div style={{ width:20,height:20,borderRadius:'50%',
//                   border:'2.5px solid rgba(255,255,255,0.3)',borderTopColor:'#fff',
//                   animation:'spin 0.8s linear infinite' }} />
//                 : <><span className="material-icons" style={{ fontSize:18 }}>check_circle_outline</span>Confirm Appointment</>
//             }
//           </button>
//           <button onClick={() => { if(validate()) notifyDoctor() }} style={{
...
//           }}>
//             <span className="material-icons" style={{ fontSize:16, color:'#25D366' }}>message</span>
...
//         <div style={{ padding:'14px 18px 12px', borderBottom:'1px solid #F0F2F8',
//           display:'flex', alignItems:'center', gap:8 }}>
//           <div style={{ width:30, height:30, borderRadius:8, background:'#EEF3FF',
//             display:'flex', alignItems:'center', justifyContent:'center' }}>
//             <span className="material-icons" style={{ fontSize:16, color:'#2979FF' }}>{icon}</span>
//           </div>
//           <p style={{ fontSize:14, fontWeight:800, color:'#0A1628', margin:0 }}>{title}</p>
//         </div>
...
// }
//
// function Field({ children, err }) {
//   return (
//       <div>
//         {children}
//         {err && <p style={{ fontSize:12, color:'#DC2626', margin:'4px 0 0',
//           display:'flex', alignItems:'center', gap:4 }}>
//           <span className="material-icons" style={{ fontSize:13 }}>error_outline</span>{err}
//         </p>}
//       </div>
//   )
// }
